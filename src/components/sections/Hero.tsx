        ...
        >
            ...
            >
                ...
                <p className="leading-5 md:leading-5 max-w-lg xl:max-w-xl md:text-lg xl:leading-6 xl:text-xl font-normal text-base">
                    I’m designing and developing modern and professional websites. Whether you need an online shop, a
                    more personal website or a fully functional web application for your business, I am always at your
                    service.
                </p>
            </AnimateWhenVisible>
        </div>
